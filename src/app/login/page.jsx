...
const LogInPage = () => {
    ...
    return (
        <div className="py-20 m-5">
            <Form onSubmit={handleSubmit(handleLoginFunc)} className="flex max-w-100 flex-col gap-4 mx-auto p-5 rounded-lg shadow-md border-2 border-black/10 bg-green-100">
