...
const Footer = () => {
    return (
        <footer className="grid grid-cols-1 md:grid-cols-4 px-15 py-20 bg-[#deedfc]">

            {/* Tiles Categories */}
            <nav className="flex flex-col items-center md:items-start gap-2 text-2xl md:text-xl font-medium">
                <h6 className="footer-title text-xl md:text-lg">Tiles Categories</h6>
            ...
            {/* Company */}
            <nav className="flex flex-col items-center md:items-start gap-2 text-2xl md:text-xl font-medium">
                <h6 className="footer-title text-xl md:text-lg mt-8 md:mt-0">Company</h6>
            ...
            {/* Support */}
            <nav className="flex flex-col items-center md:items-start gap-2 text-2xl md:text-xl font-medium">
                <h6 className="footer-title text-xl md:text-lg mt-8 md:mt-0">Support</h6>
            ...
            <nav className="flex flex-col items-center md:items-start gap-4">
                <h6 className="footer-title text-xl md:text-lg mt-8 md:mt-0">Follow Us</h6>
